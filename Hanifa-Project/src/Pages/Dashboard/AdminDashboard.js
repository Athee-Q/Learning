                            ...
                            <div className="row no-gutters align-items-center">
                                <div className="col mr-2">
                                    <div className="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                        No of Students</div>
                                    <div className="h5 mb-0 font-weight-bold text-gray-800">71</div>
                                </div>
                            ...
                            <div className="row no-gutters align-items-center">
                                <div className="col mr-2">
                                    <div className="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                        Fee Pending</div>
                                    <div className="h5 mb-0 font-weight-bold text-gray-800">140</div>
                                </div>
                                <div className="col-auto">
                ...
                <div className="col-xl-3 col-md-6 mb-4">
                    <div className="card border-left-info shadow h-100 py-2">
                        <div className="card-body">
                            <div className="row no-gutters align-items-center">
                                <div className="col mr-2">
                                    <div className="text-xs font-weight-bold text-info text-uppercase mb-1">No of Batch
                                    </div>
                                    <div className="row no-gutters align-items-center">
                                        <div className="col-auto">
                ...
                <div className="col-lg-12 mb-4 ">
                    <div className="card shadow mb-4" >
                        <div className="card-header py-3">
                            ...
                            <div className="row justify-content-end mt-lg-n4"> 
                              <button className="btn btn-primary btn-md" onClick={openModal}>ADD</button></div>
